...
- Predicts 8 specialized somatotype measurements using literature-based equations:
...
- Implements validated equations from Jackson-Pollock, Durnin-Womersley, and Heymsfield research
- Uses hybrid approach combining CAESAR dataset training with scientific literature
- Includes advanced confidence scoring and physiological validation
...
#### Main Workflows
- **photos2avatar.py**: Standard 3D avatar generation pipeline
- **photos2somatotype.py**: Specialized somatotype analysis with literature-based predictions  
- Automatic silhouette extraction using DeepLabV3
- CNN-based measurement extraction from photos
- MICE imputation for missing measurements
- Literature-validated somatotype prediction equations
