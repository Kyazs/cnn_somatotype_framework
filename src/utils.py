...
OBJ_FILES_DS_DIR_DICT = {
    name: os.path.join(OBJ_FILES_DIR, f"obj_database_{name}") for name in DBNAMES
}
...
UK_MEAS = [
    ...
    "arm_circumference_flexed",      # Arm_Circumference_Flexed (CNN's direct measurement)
    "calf_circumference",            # Calf_Circumference (CNN's direct measurement)
]
